...
public class CalculadoraVentana extends JFrame implements ActionListener {
 ...
 public void actionPerformed(ActionEvent e) {
  ...
  if(e.getSource() == acerca){
   JOptionPane.showMessageDialog(null, "                Calculadora de Ventana  \n Tomás Mateo Núñez Ríos - Ejercicio de clase");
  }
 }
 
 public static void main(String[] ar){
  CalculadoraVentana casio = new CalculadoraVentana();
  casio.setBounds(10, 10, 400, 400);
  casio.setResizable(false);
