package BoletinPOO3.Ej3.Main;

import BoletinPOO3.Ej3.Clases.Disco;
import java.util.Scanner;

public class MainColeccionEjemplo {
		...
		do {
			...
			switch (opcion) {
				...
				case 3:
					...
					System.out.print("Duración: ");
					duracionIntroducidaString = tecladoS.nextLine();
